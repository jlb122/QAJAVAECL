...
//		System.out.println("Hello, World");
		...
		boolean over40, male; // OK but not good practice as we can't easily see all declaration
...
//		String statement = "This is answer to the ultimate question!";
...
//		System.out.println(myString.toString());
		...
		int[] array1 = new int[7];		// Declares an empty 7 element array type of int
		...
		// SIZES of array 1-3 are now fixed
		
		int numFromArray = array1[3];
		int numFromArray2 = array2[5];
		String stringFromArray3 = array3[2];
		
		System.out.println(numFromArray);		// null? -> 00000000000
		System.out.println(numFromArray2);		// 60
		System.out.println(stringFromArray3);	// Freddie
